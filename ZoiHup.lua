...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Nhận Cày Thuê Bán Acc Ae Nào Cần IB" , 6 ,11816162894 )
...
--------------------------------------------------------------------
local Library = Update:Window("Zoi Hup","")
------------------------------------------
...
Setting:Button("Sao Chép Link Facebook",function()
 ...
 setclipboard("https://www.facebook.com/profile.php?id=61555490759413&mibextid=9R9pXO")
